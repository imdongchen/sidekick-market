    ...
    <div className="mt-8 max-w-xl">
      ...
      {engagement.weeklySessions === null && (
        <p className="mt-2 text-xs text-zinc-500">
          Weekly usage requires PostHog API credentials (
          <code className="text-zinc-600">POSTHOG_PERSONAL_API_KEY</code>,{' '}
          <code className="text-zinc-600">POSTHOG_PROJECT_ID</code>).
        </p>
      )}
    </div>
  )
