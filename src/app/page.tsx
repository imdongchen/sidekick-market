          ...
          <div className="pt-16 sm:pt-24 md:pt-32">
            ...
            <p className="mt-8">
              *The Android app is currently in beta testing and not yet publicly
              ...
              from the link above. Not working? Try downloading <u><Link href="https://github.com/imdongchen/sidekick/releases/download/v1.6.28/build-1749947550072.apk">this APK</Link></u> instead.
            </p>
            <p className="mt-8">
